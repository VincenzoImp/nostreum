    ...
    <div className="max-w-2xl mx-auto p-4 space-y-6">
      ...
      <div className="card bg-base-100 shadow-lg border-2 border-base-300">
        <div className="card-body items-center text-center p-8">
          ...
          <p className="text-base-content/70 mb-6 max-w-md">{content.description}</p>
          ...
          <div className="flex gap-3 flex-wrap justify-center">
            ...
            <button className="btn btn-ghost" onClick={handleGoBack} type="button">
              <ArrowLeftIcon className="w-4 h-4" />
              Go Back
            </button>
          </div>
      ...
      <div className="text-center py-4 bg-base-200 rounded-xl">
        ...
        <p className="text-sm opacity-80 mb-4">If you're still having trouble finding a profile, try these options:</p>
